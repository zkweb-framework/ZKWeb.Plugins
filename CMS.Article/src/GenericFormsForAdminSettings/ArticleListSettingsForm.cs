...
namespace ZKWeb.Plugins.CMS.Article.src.GenericFormsForAdminSettings {
	/// <summary>
	/// 商品列表设置
	/// </summary>
	[ExportMany]
	public class ArticleListSettingsForm : GenericFormForAdminSettings {
		public override string Group { get { return "ArticleSettings"; } }
		public override string GroupIcon { get { return "fa fa-pencil"; } }
