...
namespace ZKWeb.Plugins.Shopping.Order.src.GenericFormsForAdminSettings {
	/// <summary>
	/// 订单设置
	/// </summary>
	[ExportMany]
	public class OrderSettingsForm : GenericFormForAdminSettings {
		public override string Group { get { return "OrderSettings"; } }
		public override string GroupIcon { get { return "fa fa-cart-arrow-down"; } }
